...
You can see the http://www.winnovative-software.com/word-to-pdf-converter.aspx product page for a complete list of library features.
...
* .NET Framework 4.8.1, 4.7.2, 4.6.1 (and above)
...
You can download the full Winnovative Word to PDF Converter for .NET Framework package from http://www.winnovative-software.com/download.aspx page of the website.
